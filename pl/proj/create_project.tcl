...
#
# create_insecure_example.tcl: Tcl script for re-creating project 'test_reduced'
#
# Generated by Vivado on Sun Mar 15 20:46:22 EDT 2020
...
#
# 1. This project restoration tcl script (create_insecure_example.tcl) that was generated.
#
...
#
#    "/home/heiko/Documents/eCTF_Competition/InsecureExample/pl/src/hdl/i2s_output.vhd"
#    "/home/heiko/Documents/eCTF_Competition/InsecureExample/pl/src/bd/system/hdl/system_wrapper.vhd"
#    "/home/heiko/Documents/eCTF_Competition/InsecureExample/pl/src/constraints/Cora-Z7-Master.xdc"
#
#*****************************************************************************************
...
set script_file "create_insecure_example.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/test_reduced"]"
...
set_property -name "ip_output_repo" -value "/home/heiko/Documents/eCTF_Competition/InsecureExample/pl/repo/cache" -objects $obj
...
set_property "ip_repo_paths" "[file normalize "$origin_dir/../repo"] [file normalize "$origin_dir/../../custom_pl/custom_ip_repo"]" $obj
...
if { [get_files i2s_output.vhd] == "" } {
  import_files -quiet -fileset sources_1 /home/heiko/Documents/eCTF_Competition/InsecureExample/pl/src/hdl/i2s_output.vhd
}
...
Audio DRM module firmware." [get_bd_designs $design_name]
  ...
  if { $bCheckIPs == 1 } {
     set list_check_ips "\ 
  user.org:user:FrankenCryptCore:14.0\
  ...
  # Create instance: FrankenCryptCore_0, and set properties
  set FrankenCryptCore_0 [ create_bd_cell -type ip -vlnv user.org:user:FrankenCryptCore:14.0 FrankenCryptCore_0 ]

  set_property -dict [ list \
   CONFIG.NUM_READ_OUTSTANDING {1} \
   CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /FrankenCryptCore_0/s00_axi]
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLK_OUT1_PORT {clk_50Mhz_out1} \
   CONFIG.CLK_OUT2_PORT {clk_10MHz_out2} \
  ...
  connect_bd_intf_net -intf_net mb_axi_mem_interconnect_0_M04_AXI [get_bd_intf_pins axi_intc_0/s_axi] [get_bd_intf_pins mb_axi_mem_interconnect_0/M04_AXI]
  connect_bd_intf_net -intf_net mb_axi_mem_interconnect_0_M05_AXI [get_bd_intf_pins FrankenCryptCore_0/s00_axi] [get_bd_intf_pins mb_axi_mem_interconnect_0/M05_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins int_axi_gpio_0/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
...
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_net -net clk_wiz_0_clk_10MHz_out2 [get_bd_pins clk_wiz_0/clk_10MHz_out2]
  connect_bd_net -net clk_wiz_0_clk_50Mhz_out1 [get_bd_pins FrankenCryptCore_0/clk_50Mhz] [get_bd_pins clk_wiz_0/clk_50Mhz_out1]
...
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins FrankenCryptCore_0/clk_200Mhz] [get_bd_pins FrankenCryptCore_0/s00_axi_aclk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins clk_wiz_25M/clk_in1] [get_bd_pins data_lmb_bram_if_cntlr_1/LMB_Clk] [get_bd_pins data_lmb_v10_1/LMB_Clk] [get_bd_pins dma_axi_bram_ctrl_1/s_axi_aclk] [get_bd_pins fifo_count_axi_gpio_0/s_axi_aclk] [get_bd_pins ins_lmb_bram_if_cntlr_0/LMB_Clk] [get_bd_pins ins_lmb_v10_0/LMB_Clk] [get_bd_pins int_axi_gpio_0/s_axi_aclk] [get_bd_pins mb_axi_mem_interconnect_0/ACLK] [get_bd_pins mb_axi_mem_interconnect_0/M00_ACLK] [get_bd_pins mb_axi_mem_interconnect_0/M01_ACLK] [get_bd_pins mb_axi_mem_interconnect_0/M02_ACLK] [get_bd_pins mb_axi_mem_interconnect_0/M03_ACLK] [get_bd_pins mb_axi_mem_interconnect_0/M04_ACLK] [get_bd_pins mb_axi_mem_interconnect_0/M05_ACLK] [get_bd_pins mb_axi_mem_interconnect_0/S00_ACLK] [get_bd_pins mb_axi_mem_interconnect_0/S01_ACLK] [get_bd_pins mb_dma_axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins microblaze_0/Clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins xadc_wiz_0/s_axi_aclk]
  ...
  connect_bd_net -net rst_ps7_0_100M_bus_struct_reset [get_bd_pins clk_wiz_0/reset] [get_bd_pins clk_wiz_25M/reset] [get_bd_pins data_lmb_bram_if_cntlr_1/LMB_Rst] [get_bd_pins data_lmb_v10_1/SYS_Rst] [get_bd_pins ins_lmb_bram_if_cntlr_0/LMB_Rst] [get_bd_pins ins_lmb_v10_0/SYS_Rst] [get_bd_pins rst_ps7_0_100M/bus_struct_reset]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins FrankenCryptCore_0/s00_axi_aresetn] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins dma_axi_bram_ctrl_1/s_axi_aresetn] [get_bd_pins fifo_count_axi_gpio_0/s_axi_aresetn] [get_bd_pins int_axi_gpio_0/s_axi_aresetn] [get_bd_pins mb_axi_mem_interconnect_0/M00_ARESETN] [get_bd_pins mb_axi_mem_interconnect_0/M01_ARESETN] [get_bd_pins mb_axi_mem_interconnect_0/M02_ARESETN] [get_bd_pins mb_axi_mem_interconnect_0/M03_ARESETN] [get_bd_pins mb_axi_mem_interconnect_0/M04_ARESETN] [get_bd_pins mb_axi_mem_interconnect_0/M05_ARESETN] [get_bd_pins mb_axi_mem_interconnect_0/S00_ARESETN] [get_bd_pins mb_axi_mem_interconnect_0/S01_ARESETN] [get_bd_pins mb_dma_axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins xadc_wiz_0/s_axi_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x80000000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs FrankenCryptCore_0/s00_axi/reg0] SEG_FrankenCryptCore_0_reg0
  create_bd_addr_seg -range 0x00010000 -offset 0x80000000 [get_bd_addr_spaces microblaze_0/Instruction] [get_bd_addr_segs FrankenCryptCore_0/s00_axi/reg0] SEG_FrankenCryptCore_0_reg0
